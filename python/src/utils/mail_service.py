...
# NEW helper functions to create email content for different scenarios in the onboarding process.
...
def compose_welcome_mail(forloeb, custom_message):
    ...
    context = {
        ...
        "link": f'<div style="margin-top: 16px;margin-bottom: 16px;display: inline-block"><a href="{link}" style="text-decoration: none;padding: 0.6rem 1rem;border-radius: 1.5rem;background-color: rgb(56, 65, 84);color: rgb(237, 229, 220);cursor: pointer;user-select: none;">Se dit onboarding-forløb</a></div>',
